	...
	bcf   PORTB,3
	bcf   PORTB,4   
	movlw   .1		;comandos para la Funcion velocidad
	movwf   2ah
	movlw   .2
	movwf   2bh
	movlw   .3
	...
	bsf   portb,0      ;Verde prende, configuraciones de los colores a prender
	movfw   portb
	movwf   3ah
	clrf   PORTB      ;TODO EN 0
...
NO10    movfw   2CH  		;comando de velocidad numero 3---------------------------------------------    
	subwf   1AH,W		;.3 - .1 deberia dar cero si se preciono porta,0
	btfss   status,2   	;Z = 1   el resultado dio cero
...
NO11    movfw   2DH		;comando de velocidad numero 4---------------------------------------------
	subwf   1AH,W		;.4 - .1 deberia dar cero si se preciono porta,0
	btfss   status,2   	;Z = 1   el resultado dio cero
...
NO12    movfw   2EH		;comando de velocidad numero 5-------------------------------------------	
	subwf   1AH,W		;.5 - .1 deberia dar cero si se preciono porta,0
	btfss   status,2   	;Z = 1   el resultado dio cero
