...
inicio	btfss	porta,0
	...
	goto	tretra		;SI
tretra	call 	demora1
	btfss	porta,0		;si es en verdad
	goto	inicio		;no fue de verdad
	goto	traba
...
lono3	btfss	porta,1
	...
	movlw	.1		;si
	movwf	2AH
	goto	cambio		;pregunta si esta en 0
...
NOPE299	MOVLW	.255		;NOPE2 CON NOPE FORMAN LOS SEGUNDOS
	MOVWF	2EH	
Nope99	MOVLW	.255		;NOPE2 CON NOPE FORMAN LOS SEGUNDOS
	MOVWF	2DH		;LO PONEMOS HAY	
NOTRO	DECFSZ	2DH,F		;DECRECEMOS
	goto	NOTRO		;SIGUE DECRECIENDO
	goto	pepre		;TERMINO
pepre	DECFSZ	2EH,F
	goto	Nope99
	goto	PEPE299
